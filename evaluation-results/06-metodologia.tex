...
Foram utilizados dois materiais contendo orientações de saúde, ambos em formato PDF e com presença de imagens ao longo do documento: o \textit{Guia de Atenção à Saúde da Pessoa com Estomia} e o \textit{Manual de cuidados com os pés para pessoas com diabetes}. Esses documentos foram escolhidos por apresentarem linguagem técnica, orientações práticas voltadas ao cuidado em saúde e elementos visuais de apoio, permitindo observar como a solução se comporta diante de conteúdos com diferentes temas, vocabulários, tipos de instrução e estrutura documental. Além disso, a escolha desses materiais é coerente com o escopo da solução, uma vez que se tratam de documentos previamente aprovados por profissionais de saúde.
