...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{p{2.8cm} X X X}
    \toprule
    \textbf{Trabalho} &
    \textbf{Contexto principal} &
    \textbf{Elementos contemplados} &
    \textbf{Elementos não contemplados ou parciais} \\
    \midrule

    Aydin et al. (2024) &
    Educação de pacientes &
    Uso de LLMs; simplificação textual parcial; adaptação parcial ao perfil do paciente; avaliação textual parcial. &
    Não aborda mHealth nem guardrails como foco da proposta. \\

    \midrule

    Loughran et al. (2024) &
    Letramento em saúde em mHealth &
    Uso de LLMs; contexto mHealth; simplificação textual; avaliação textual. &
    Adaptação ao perfil do paciente aparece de forma parcial; não enfatiza guardrails. \\

    \midrule

    Jeblick et al. (2024) &
    Simplificação de laudos radiológicos &
    Uso de LLMs; simplificação textual; avaliação humana da saída. &
    Não aborda mHealth, adaptação ao perfil do paciente nem guardrails. \\

    \midrule

    Dong et al. (2024) &
    Guardrails para LLMs &
    Uso de LLMs; discussão específica sobre guardrails. &
    Não aborda mHealth, simplificação textual em saúde, adaptação ao perfil do paciente nem avaliação textual. \\

    \midrule

    Gangavarapu (2024) &
    Guardrails em IA para saúde &
    Uso de LLMs; discussão sobre guardrails no domínio da saúde. &
    Não aborda mHealth, simplificação textual, adaptação ao perfil do paciente nem avaliação textual. \\
